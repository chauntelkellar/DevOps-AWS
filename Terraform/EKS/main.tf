...
resource "aws_eks_cluster" "ckdevopsaws-eks" {
  name = "ckdevopsaws-cluster"
...
resource "aws_eks_fargate_profile" "ckdevopsaws-eks-serverless" {
  cluster_name           = aws_eks_cluster.ckdevopsaws-eks.name
  fargate_profile_name   = "ckdevopsaws-serverless-eks"
