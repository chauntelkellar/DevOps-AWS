...
These are the steps to create the Docker image to containerize the Uber app.

## Create The Docker Image

1. `cd` into the *Docker* directory where you will see a *Dockerfile* and *app* directory. The app directory is what stores the Python application and the Dockerfile will be used to build the app. The app directory was cloned from here [Python-Sample-Application](https://github.com/chauntelkellar/Python-Sample-Application)

2. Open the Dockerfile

3. Within the Dockerfile, there are the following key components
...
4. To create the Docker image, run the following command:
